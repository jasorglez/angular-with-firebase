...
const routes: Routes = [
	...
	{ path: '',
      ...
      { path: 'plaint', loadChildren: () => import('./main-page/plaint/plaint.module').then(m=>m.PlaintModule)},
      { path: 'comunicac', loadChildren: () => import('./main-page/comunicac/comunicac.module').then(m=>m.ComunicModule)},
